...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: "Александр Васильев — целитель, шаман, эксперт по духовным практикам и работе с подсознанием. Моя история — путь от преодоления личных кризисов и болезней к призванию помогать другим. Я использую древние шаманские техники, вегетализм, работу с подсознанием, чтобы исцелять, возвращать гармонию и радость жизни. Более 1000 успешных случаев, индивидуальный подход, глубокая трансформация. Помогаю избавиться от страхов, зависимостей, найти своё предназначение и внутреннюю силу. Запишитесь на консультацию и начните путь к гармонии и здоровью! Ключевые слова: целитель Казань, шаман, духовные практики, работа с подсознанием, исцеление, гармония, личная трансформация, избавление от страхов, восстановление здоровья, шаманизм, вегетализм, индивидуальный подход, консультация целителя.",
  };
