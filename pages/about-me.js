...
export default function () {
  ...
  const metaConfig = {
    ...
    description: "Путь от личных испытаний к призванию помогать людям через исцеление",
    keywords: "целитель, духовные практики, личная история",
    seoContent: "Александр Васильев — проводник и специалист по трансформации подсознания, энергетическим практикам и исцелению. Мой путь — от личных испытаний и выздоровления к служению людям. Использую традиционные шаманские методы, вегетализм и глубокую работу с подсознанием, чтобы возвращать внутренний баланс и радость жизни.  Индивидуальный подход, ощутимые изменения. Помогаю освобождаться от фобий и зависимостей, находить предназначение и силу. Запишитесь на консультацию, чтобы открыть путь к гармонии и благополучию. Ключевые слова: мастер исцеления Казань, шаманский проводник, энергетические практики, трансформация подсознания, духовное восстановление, внутренний баланс, личностная трансформация, избавление от фобий, исцеление души, шаманские традиции, вегетализм, персональный подход, консультация.",
  };
