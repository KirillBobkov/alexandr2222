    ...
    <Layout metaConfig={metaConfig}>
      ...
      <LineAnimation>
        <div className={containerStyles.container}>
          ...
          <VisibilityManager as="p">
            Когда мне было 17 лет, он провёл обряд посвящения, открыв мне двери в мир сакральных знаний. Он обучил меня различным техникам исцеления, включая экстатические практики, позволяющие работать с внетелесным опытом.
          </VisibilityManager>
          ...
          <VisibilityManager as="p">
            Высшие Силы многократно пытались направить меня, посылая испытания и знаки. Болезни, финансовые кризисы, выгорание, экзистенциальные проблемы— всё это преследовало меня до тех пор, пока не начал серьёзно задумываться, почему жизнь снова и снова возвращает к теме исцеления.
          </VisibilityManager>
