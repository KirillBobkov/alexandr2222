...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: "Александр Васильев — мастер исцеления, шаманский проводник, специалист по энергетическим практикам и трансформации подсознания. Моё становление — это путешествие от личного преодоления жизненных испытаний и недугов к миссии служения людям. Применяю традиционные шаманские методики, вегетализм, глубинную работу с подсознанием для восстановления, возврата внутреннего баланса и жизненной радости. Свыше 1000 результативных исцелений, персонализированный подход, кардинальная трансформация. Содействую освобождению от фобий, аддикций, обретению жизненного призвания и внутренней мощи. Обратитесь за консультацией и откройте дорогу к гармонии и благополучию! Ключевые слова: мастер исцеления Казань, шаманский проводник, энергетические практики, трансформация подсознания, духовное восстановление, внутренний баланс, личностная трансформация, освобождение от фобий, оздоровление души, шаманские традиции, вегетализм, персональный подход, консультация мастера исцеления.",
  };

  // schemaOrg добавляется перед return, если его нет
  const schemaOrg = {
    "@context": "https://schema.org",
    "@type": "Person",
    name: "Александр Васильев",
    description: "Александр Васильев — целитель, шаман, эксперт по духовным практикам, работе с подсознанием и личной трансформации. Помогаю людям преодолеть внутренние кризисы, избавиться от страхов, зависимостей, найти гармонию и своё предназначение. Более 1000 успешных случаев, индивидуальный подход, глубокая работа с подсознанием и древними шаманскими техниками.",
    url: "https://alexandrvasilev.ru/about-me",
    jobTitle: "Целитель, шаман, эксперт по духовным практикам",
    knowsAbout: ["Шаманизм", "Вегетализм", "Работа с подсознанием", "Духовные практики", "Личная трансформация"],
    sameAs: [
