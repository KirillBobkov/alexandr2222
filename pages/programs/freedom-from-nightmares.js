...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: 'Избавьтесь от ночных кошмаров и бессонницы навсегда! Программа Александра Васильева — это нейротраблшутинг: устранение подсознательных причин, глубокая работа с психикой, индивидуальный подход, быстрый результат. Без таблеток и гипноза. Более 1000 успешных случаев, гарантия результата или возврат денег. Ключевые слова: ночные кошмары, плохие сны, нейротраблшутинг, психотерапия, избавление от кошмаров, Казань, консультация, работа с подсознанием, улучшение сна, восстановление здоровья.',
    content: '',
