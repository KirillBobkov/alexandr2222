...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Спокойный сон методом гипнопроработки',
    keywords: 'ночные кошмары, плохие сны, гипнопроработка, психотерапия, избавление от кошмаров, Казань, консультация, работа с подсознанием, улучшение сна',
    seoContent: 'Освободитесь от ночных кошмаров и инсомнии окончательно! Методика Александра Васильева — гипнопроработка: ликвидация подсознательных истоков, углубленная психологическая терапия, персонализированный подход, стремительные результаты. Без медикаментозных средств. Ключевые слова: ночные кошмары, тревожные сновидения, гипнопроработка, психотерапевтическая помощь, освобождение от кошмаров, Казань, профессиональная консультация, терапия подсознания, оптимизация сна, восстановление здорового отдыха.',
    content: '',
