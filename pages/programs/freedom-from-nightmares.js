...
"name": "Трансформация ночных кошмаров и бессонных состояний",
  "description": "Полное и окончательное избавление от н кошмаров и нарушений сна навсегда! Инновационная программа Александра Васильева — передовая направленная медитация: глубинная нейтрализация подсознательных источников, комплексная перестройка психических процессов, индивидуально разработанный подход, моментальное достижение устойчивых результатов. Без медикаментозных средств и гипнотических методик. Уже свыше 100 успешно завершенных случаев, гарантированный результат или финансовая компенсация. Ключевые слова: ночные кошмары лечение, бессонные состояния, направленная медитация сновидений, глубинная психотерапия, избавление от кошмаров, Казань, профессиональная консультация, работа с подсознанием, улучшение качества сна, восстановление психического здоровья, трансформация сна, выздоровление.",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Спокойный сон методом направленной медитации',
    keywords: 'ночные кошмары, плохие сны, направленная медитация, психотерапия, избавление от кошмаров, Казань, консультация, работа с подсознанием, улучшение сна',
    seoContent: 'Освободитесь от ночных кошмаров и инсомнии окончательно! Методика Александра Васильева — направленная медитация: ликвидация подсознательных истоков, углубленная психологическая терапия, персонализированный подход, стремительные результаты. Без медикаментозных средств. Ключевые слова: ночные кошмары, тревожные сновидения, направленная медитация, психотерапевтическая помощь, освобождение от кошмаров, Казань, профессиональная консультация, терапия подсознания, оптимизация сна, восстановление здорового отдыха.',
    content: '',
    ...
    <Layout metaConfig={metaConfig} schemaOrg={schemaOrg}>
      <SecondaryPreview text={metaConfig.pageTitle} image={secondary_preview_16} />
        <div className={containerStyles.container}>
          ...
          <div style={{ height: '1px' }} />
          <VisibilityManager as="h3" className={contentStyles.title_middle}>
            Как работает направленная медитация?
          </VisibilityManager>
