...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Нейтрализация травмирующих воспоминаний с помощью гипнопроработки',
    keywords: 'травматические воспоминания, психологические травмы, гипнопроработка, избавление от травм, эмоциональная свобода, Казань, консультация, работа с подсознанием, внутренний покой',
    seoContent: 'Освободитесь от деструктивных воспоминаний и эмоциональных ограничений. Гипнопроработка Александра Васильева: нейтрализация травмирующих переживаний, восстановление психологического благополучия, индивидуальный подход, быстрый результат. Более 100 случаев, гарантия результата или возврат. Ключевые слова: травматические воспоминания, психологические травмы, гипнопроработка, освобождение от травм, эмоциональная свобода, Казань, консультация, работа с подсознанием, внутренний покой, психологическая гармония.',
    content: '',
      ...
      />
        <div className={containerStyles.container}>
          <VisibilityManager as="p">
            ...
            вам двигаться вперед. Гипнопроработка предлагает эффективный
