...
"name": "Трансформация травматических воспоминаний и эмоциональной свободы",
  ...
  "serviceType": "Направленная медитация травматических воспоминаний",
  "offers": {
    "@type": "Offer",
    "price": "По запросу",
    "priceCurrency": "RUB",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Нейтрализация травмирующих воспоминаний с помощью направленной медитации',
    keywords: 'травматические воспоминания, психологические травмы, направленная медитация, избавление от травм, эмоциональная свобода, Казань, консультация, работа с подсознанием, внутренний покой',
    seoContent: 'Освободитесь от деструктивных воспоминаний и эмоциональных ограничений. Направленная медитация Александра Васильева: нейтрализация травмирующих переживаний, восстановление психологического благополучия, индивидуальный подход, быстрый результат. Более 100 случаев, гарантия результата или возврат. Ключевые слова: травматические воспоминания, психологические травмы, направленная медитация, освобождение от травм, эмоциональная свобода, Казань, консультация, работа с подсознанием, внутренний покой, психологическая гармония.',
    content: '',
      ...
      />
        <div className={containerStyles.container}>
          <VisibilityManager as="p">
            ...
            вам двигаться вперед. Направленная медитация предлагает эффективный
