...
const schemaOrg = {
  ...
  "description": "Избавьтесь от негативных воспоминаний и эмоциональных блоков! Программа Александра Васильева — это нейротраблшутинг: нейтрализация травмирующих событий, восстановление психологического благополучия, индивидуальный подход, быстрый результат. Более 1000 успешных случаев, гарантия результата или возврат денег. Ключевые слова: травматические воспоминания, психологические травмы, нейротраблшутинг, избавление от травм, эмоциональная свобода, Казань, консультация, работа с подсознанием, внутренний покой, гармония.",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Нейтрализация травмирующих воспоминаний методом нейротраблшутинга',
    keywords: 'травматические воспоминания, психологические травмы, нейротраблшутинг, избавление от травм, эмоциональная свобода, Казань, консультация, работа с подсознанием, внутренний покой',
    seoContent: 'Освободитесь от деструктивных воспоминаний и эмоциональных ограничений! Методика Александра Васильева — нейротраблшутинг: нейтрализация травмирующих переживаний, восстановление психологического благополучия, персонализированный подход, стремительные результаты. Свыше 1000 результативных случаев, гарантия эффекта или полное возмещение. Ключевые слова: травматические переживания, психологические травмы, нейротраблшутинг, освобождение от травм, эмоциональная свобода, Казань, профессиональная консультация, терапия подсознания, внутренний покой, психологическая гармония.',
    content: '',
