...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Нейтрализация травмирующих воспоминаний с помощью нейротраблшутинга',
    ...
    seoContent: 'Освободитесь от деструктивных воспоминаний и эмоциональных ограничений. Нейротраблшутинг Александра Васильева: нейтрализация травмирующих переживаний, восстановление психологического благополучия, индивидуальный подход, быстрый результат. Более 100 случаев, гарантия результата или возврат. Ключевые слова: травматические воспоминания, психологические травмы, нейротраблшутинг, освобождение от травм, эмоциональная свобода, Казань, консультация, работа с подсознанием, внутренний покой, психологическая гармония.',
    content: '',
