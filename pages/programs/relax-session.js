...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Глубокая релаксация и восстановление энергии методом гипнопроработки',
    keywords: 'релаксация, снятие стресса, гипнопроработка, вегетализм, восстановление энергии, Казань, консультация, работа с подсознанием, внутренний покой',
    seoContent: 'Глубокая релаксация и восстановление жизненной энергии. Сессия Александра Васильева: гипнопроработка, вегетализм и современные техники для снятия стресса, внутреннего равновесия, улучшения сна и активации энергии. Индивидуальный подход, быстрый эффект. Более 100 кейсов, гарантия результата или возврат. Ключевые слова: релаксация, снятие стресса, гипнопроработка, вегетализм, восстановление энергии, Казань, консультация, работа с подсознанием, внутренний покой, энергетическая гармония.',
    content: '',
      ...
      />
        <div className={containerStyles.container}>
          ...
          <VisibilityManager as="p">
            ...
            гипнопроработки, я помогу вам достичь состояния глубокого
