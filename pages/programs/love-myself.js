...
const schemaOrg = {
  ...
  "description": "Устранение подсознательных блоков, мешающих полюбить себя, повышение самооценки и уверенности в себе с помощью нейротраблшутинга",
...
export default function () {
  ...
  const metaConfig = {
    ...
    keywords: "самооценка, уверенность в себе, любовь к себе, нейротраблшутинг, личностный рост",
    content: "",
