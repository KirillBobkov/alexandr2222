...
"name": "Трансформационная программа «Обретение любви к себе»",
  "description": "Восстановите любовь к себе и обретите глубокую внутреннюю гармонию! Инновационная программа Александра Васильева — передовая направленная медитация: полное устранение внутренних блоков, препятствующих самоценности, значительное повышение самооценки, индивидуально разработанный подход, моментальное достижение устойчивых результатов. Уже свыше 100 успешно завершенных случаев, гарантированный результат или финансовое возмещение. Ключевые слова: восстановление самооценки, формирование уверенности в себе, обретение любви к себе, направленная медитация личностного роста, трансформация самоотношения, Казань, профессиональная консультация, глубинная работа с подсознанием, достижение внутренней гармонии, полное само принятие, трансформация личности.",
  ...
  "serviceType": "Направленная медитация личностного роста",
  "offers": {
    "@type": "Offer",
    "price": "По запросу",
    "priceCurrency": "RUB",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Повышение самооценки и уверенности в себе с помощью направленной медитации',
    keywords: 'самооценка, уверенность в себе, любовь к себе, направленная медитация, личностный рост, Казань, консультация, работа с подсознанием, гармония',
    seoContent: 'Развивайте самопринятие и приходите к внутренней гармонии. Направленная медитация Александра Васильева: устранение препятствий, мешающих любви к себе, рост самооценки, персональный подход, быстрый эффект. Более 100 успешных случаев, гарантия результата или возврат средств. Ключевые слова: самооценка, уверенность, самопринятие, направленная медитация, личностное развитие, Казань, консультация, работа с подсознанием, внутренняя гармония, принятие себя.',
    content: '',
    ...
    <Layout metaConfig={metaConfig} schemaOrg={schemaOrg}>
      ...
      />
        <div className={containerStyles.container}>
          ...
          <VisibilityManager as="p">
            Направленная медитация — это уникальный метод работы с подсознанием,
