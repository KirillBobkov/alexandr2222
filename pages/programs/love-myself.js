...
"name": "Трансформационная программа «Обретение любви к себе»",
  "description": "Восстановите любовь к себе и обретите глубокую внутреннюю гармонию! Инновационная программа Александра Васильева — передовой нейротраблшутинг: полное устранение внутренних блоков, препятствующих самоценности, значительное повышение самооценки, индивидуально разработанный подход, моментальное достижение устойчивых результатов. Уже свыше 100 успешно завершенных случаев, гарантированный результат или финансовое возмещение. Ключевые слова: восстановление самооценки, формирование уверенности в себе, обретение любви к себе, нейротраблшутинг личностного роста, трансформация самоотношения, Казань, профессиональная консультация, глубинная работа с подсознанием, достижение внутренней гармонии, полное само принятие, трансформация личности.",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Повышение самооценки и уверенности в себе с помощью нейротраблшутинга',
    ...
    seoContent: 'Развивайте самопринятие и приходите к внутренней гармонии. Нейротраблшутинг Александра Васильева: устранение препятствий, мешающих любви к себе, рост самооценки, персональный подход, быстрый эффект. Более 100 успешных случаев, гарантия результата или возврат средств. Ключевые слова: самооценка, уверенность, самопринятие, нейротраблшутинг, личностное развитие, Казань, консультация, работа с подсознанием, внутренняя гармония, принятие себя.',
    content: '',
