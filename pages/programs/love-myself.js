...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Повышение самооценки и уверенности в себе с помощью гипнопроработки',
    keywords: 'самооценка, уверенность в себе, любовь к себе, гипнопроработка, личностный рост, Казань, консультация, работа с подсознанием, гармония',
    seoContent: 'Развивайте самопринятие и приходите к внутренней гармонии. Гипнопроработка Александра Васильева: устранение препятствий, мешающих любви к себе, рост самооценки, персональный подход, быстрый эффект. Более 100 успешных случаев, гарантия результата или возврат средств. Ключевые слова: самооценка, уверенность, самопринятие, гипнопроработка, личностное развитие, Казань, консультация, работа с подсознанием, внутренняя гармония, принятие себя.',
    content: '',
    ...
    <Layout metaConfig={metaConfig} schemaOrg={schemaOrg}>
      ...
      />
        <div className={containerStyles.container}>
          ...
          <VisibilityManager as="p">
            Гипнопроработка — это уникальный метод работы с подсознанием,
