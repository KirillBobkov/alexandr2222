...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Увеличение заработка и финансового роста методом гипнопроработки',
    keywords: 'финансовый рост, увеличение дохода, гипнопроработка, подсознательные блоки, Казань, консультация, работа с подсознанием, деньги, финансовая свобода',
    seoContent: 'Расширьте доход и финансовую свободу. Гипнопроработка Александра Васильева: устранение подсознательных препятствий, проработка ограничивающих убеждений, индивидуальный подход, быстрый результат. Более 100 кейсов, гарантия результата или возврат средств. Ключевые слова: финансовое развитие, рост доходов, гипнопроработка, подсознательные ограничения, Казань, консультация, работа с подсознанием, благосостояние, финансовая независимость, успех.',
    content: '',
    ...
    <Layout metaConfig={metaConfig} schemaOrg={schemaOrg}>
      ...
      />
        <div className={containerStyles.container}>
          ...
          <VisibilityManager as="p">
            Гипнопроработка - это мощный инструмент, который позволяет выявить
