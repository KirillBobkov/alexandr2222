...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: 'Увеличьте свой доход и финансовую свободу! Программа Александра Васильева — это нейротраблшутинг: устранение подсознательных блоков, проработка ограничивающих убеждений, индивидуальный подход, быстрый результат. Более 1000 успешных случаев, гарантия результата или возврат денег. Ключевые слова: финансовый рост, увеличение дохода, нейротраблшутинг, подсознательные блоки, Казань, консультация, работа с подсознанием, деньги, финансовая свобода, успех.',
    content: '',
