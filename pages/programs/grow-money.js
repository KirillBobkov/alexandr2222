...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Увеличить заработок и финансовый рост методом нейротраблшутинга',
    ...
    seoContent: 'Расширьте свои доходы и финансовую независимость! Методика Александра Васильева — нейротраблшутинг: ликвидация подсознательных препятствий, проработка ограничивающих убеждений, персонализированный подход, стремительные результаты. Свыше 1000 результативных кейсов, обеспечение эффекта или полная компенсация. Ключевые слова: финансовое развитие, расширение доходов, нейротраблшутинг, подсознательные ограничения, Казань, профессиональная консультация, терапия подсознания, материальное благополучие, финансовая независимость, коммерческий успех.',
    content: '',
