...
"name": "Комплексная трансформация аллергических состояний",
  ...
  "serviceType": "Направленная медитация психосоматических состояний",
  "offers": {
    "@type": "Offer",
    "price": "По запросу",
    "priceCurrency": "RUB",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Свобода от аллергии с помощью направленной медитации',
    keywords: 'аллергия, психосоматика, направленная медитация, лечение аллергии, избавление от аллергии, Казань, консультация, здоровье, работа с подсознанием',
    seoContent: 'Освободитесь от аллергических реакций. Направленная медитация Александра Васильева: устранение психосоматических причин, глубокая работа с подсознанием, персональный подход, быстрый результат. Без лекарств и гипноза. Более 100 кейсов, гарантия результата или возврат. Ключевые слова: аллергические реакции, психосоматические факторы, направленная медитация, терапия аллергии, освобождение от аллергии, Казань, консультация, оздоровление, работа с подсознанием, восстановление здоровья.',
    content: '',
