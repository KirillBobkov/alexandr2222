...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: 'Избавьтесь от аллергии навсегда! Программа Александра Васильева — это нейротраблшутинг: устранение психосоматических причин, глубокая работа с подсознанием, индивидуальный подход, быстрый результат. Без таблеток и гипноза. Более 1000 успешных случаев, гарантия результата или возврат денег. Ключевые слова: аллергия, психосоматика, нейротраблшутинг, лечение аллергии, избавление от аллергии, Казань, консультация, здоровье, работа с подсознанием, восстановление здоровья.',
    content: '',
