...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Свобода от аллергии с помощью гипнопроработки',
    keywords: 'аллергия, психосоматика, гипнопроработка, лечение аллергии, избавление от аллергии, Казань, консультация, здоровье, работа с подсознанием',
    seoContent: 'Освободитесь от аллергических реакций. Гипнопроработка Александра Васильева: устранение психосоматических причин, глубокая работа с подсознанием, персональный подход, быстрый результат. Без лекарств и гипноза. Более 100 кейсов, гарантия результата или возврат. Ключевые слова: аллергические реакции, психосоматические факторы, гипнопроработка, терапия аллергии, освобождение от аллергии, Казань, консультация, оздоровление, работа с подсознанием, восстановление здоровья.',
    content: '',
