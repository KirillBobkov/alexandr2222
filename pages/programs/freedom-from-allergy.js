...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: 'Освободитесь от аллергических реакций окончательно! Методика Александра Васильева — нейротраблшутинг: ликвидация психосоматических истоков, углубленная терапия подсознания, персонализированный подход, быстродействующие результаты. Без фармакологического вмешательства и гипнотических методов. Свыше 1000 результативных случаев, гарантия эффекта или полное возмещение. Ключевые слова: аллергические проявления, психосоматические факторы, нейротраблшутинг, терапия аллергии, освобождение от аллергии, Казань, экспертная консультация, оздоровление, терапия подсознания, восстановление здорового состояния.',
    content: '',
