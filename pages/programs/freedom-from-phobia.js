...
"name": "Трансформация фобий и тревожных состояний",
  "description": "Лечебная программа полного освобождения от любых фобических проявлений и тревожных расстройств навсегда! Метод Александра Васильева — инновационная направленная медитация: глубинная нейтрализация психологических триггеров, коррекция подсознательных установок, персонализированный подход, моментальные изменения. Без медикаментозного лечения и гипнотических техник. Уже свыше 100 успешно завершенных случаев, гарантированный результат или финансовая компенсация. Ключевые слова: фобическая патология, тревожные расстройства лечение, направленная медитация фобий, глубинная психотерапия, нейтрализация страхов, трансформация тревожности, Казань, профессиональная консультация, работа с подсознанием, восстановление психического здоровья, избавление от фобий, полное выздоровление.",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Преодоление фобий с помощью направленной медитации',
    keywords: 'фобии, страхи, тревоги, направленная медитация, психотерапия, избавление от страхов, Казань, консультация, работа с подсознанием',
    seoContent: 'Победите фобические расстройства и страхи. Направленная медитация Александра Васильева: устранение глубинных психологических причин, работа с подсознанием, персональный подход, быстрый эффект. Без лекарств и гипноза. Более 100 кейсов, гарантия результата или возврат. Ключевые слова: фобии, страхи, тревожность, направленная медитация, психологическая помощь, освобождение от страхов, Казань, консультация, работа с подсознанием, восстановление благополучия.',
    content: '',
