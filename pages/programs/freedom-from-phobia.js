...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Преодоление фобий с помощью нейротраблшутинга',
    ...
    seoContent: 'Победите фобические расстройства и страхи. Нейротраблшутинг Александра Васильева: устранение глубинных психологических причин, работа с подсознанием, персональный подход, быстрый эффект. Без лекарств и гипноза. Более 100 кейсов, гарантия результата или возврат. Ключевые слова: фобии, страхи, тревожность, нейротраблшутинг, психологическая помощь, освобождение от страхов, Казань, консультация, работа с подсознанием, восстановление благополучия.',
    content: '',
