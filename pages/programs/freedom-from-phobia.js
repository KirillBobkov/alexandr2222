...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Преодоление фобий с помощью гипнопроработки',
    keywords: 'фобии, страхи, тревоги, гипнопроработка, психотерапия, избавление от страхов, Казань, консультация, работа с подсознанием',
    seoContent: 'Победите фобические расстройства и страхи. Гипнопроработка Александра Васильева: устранение глубинных психологических причин, работа с подсознанием, персональный подход, быстрый эффект. Без лекарств и гипноза. Более 100 кейсов, гарантия результата или возврат. Ключевые слова: фобии, страхи, тревожность, гипнопроработка, психологическая помощь, освобождение от страхов, Казань, консультация, работа с подсознанием, восстановление благополучия.',
    content: '',
