...
const schemaOrg = {
  ...
  "@type": "Service",
name: "Трансформационная программа освобождения от табачной зависимости",
  description: "Мгновенное и полное избавление от никотиновой зависимости — это реально! Лечебная программа Александра Васильева основана на передовых методах направленной медитации: глубинная перестройка подсознательных механизмов, полное устранение корневых причин зависимости, индивидуально адаптированный подход, мгновенное достижение результатов. Без использования фармацевтических препаратов и гипнотических техник. Уже свыше 100 успешно завершенных случаев, гарантированный результат или финансовое возмещение. Ключевые слова: табачная зависимость лечение, никотиновая нейтрализация, направленная медитация зависимостей, полное избавление от курения, Казань, профессиональная консультация, восстановление здоровья, глубинная работа с подсознанием, отказ от курения, трансформация зависимости, восстановление жизненного тонуса.",
  url: `${SITE_URL}/programs/drop-smoking`,
  provider: {
    "@type": "Person",
    name: "Александр Васильев",
    description:
      "Гипнотерапевт, специалист по работе с подсознанием и зависимостями",
    url: `${SITE_URL}/#about`,
  },
  areaServed: "Казань и онлайн",
  serviceType: "Направленная медитация зависимостей",
  offers: {
    "@type": "Offer",
    price: "По запросу",
    priceCurrency: "RUB",
    availability: "https://schema.org/InStock",
    url: `${SITE_URL}/programs/drop-smoking#message`,
  },
  serviceOutput: {
    "@type": "Thing",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": `${SITE_URL}/programs/drop-smoking`,
  },
};
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Эффективное избавление от никотиновой зависимости методом направленной медитации',
    keywords: 'бросить курить, никотиновая зависимость, направленная медитация, избавление от курения, Казань, консультация, работа с подсознанием, здоровье, отказ от курения',
    seoContent: 'Окончательно отказаться от курения — достижимо! Методика Александра Васильева базируется на направленной медитации: углубленная терапия подсознания, ликвидация корневых причин аддикции, персонализированный подход, стремительные результаты. Без медикаментов и гипнотических техник. Ключевые слова: отказ от табакокурения, никотиновая аддикция, направленная медитация, освобождение от курения, Казань, профессиональная консультация, оздоровление, терапия подсознания, преодоление курения, восстановление здорового образа жизни.',
    content: '',
