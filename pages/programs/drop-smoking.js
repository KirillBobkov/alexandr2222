...
name: "Трансформационная программа освобождения от табачной зависимости",
  description: "Мгновенное и полное избавление от никотиновой зависимости — это реально! Лечебная программа Александра Васильева основана на передовых методах нейротраблшутинга: глубинная перестройка подсознательных механизмов, полное устранение корневых причин зависимости, индивидуально адаптированный подход, мгновенное достижение результатов. Без использования фармацевтических препаратов и гипнотических техник. Уже свыше 100 успешно завершенных случаев, гарантированный результат или финансовое возмещение. Ключевые слова: табачная зависимость лечение, никотиновая нейтрализация, нейротраблшутинг зависимостей, полное избавление от курения, Казань, профессиональная консультация, восстановление здоровья, глубинная работа с подсознанием, отказ от курения, трансформация зависимости, восстановление жизненного тонуса.",
...
export default function () {
  ...
  const metaConfig = {
    ...
    keywords: 'бросить курить, никотиновая зависимость, нейротраблшутинг, избавление от курения, Казань, консультация, работа с подсознанием, здоровье, отказ от курения',
    seoContent: 'Окончательно отказаться от курения — достижимо! Методика Александра Васильева базируется на нейротраблшутинге: углубленная терапия подсознания, ликвидация корневых причин аддикции, персонализированный подход, стремительные результаты. Без медикаментов и гипнотических техник. Ключевые слова: отказ от табакокурения, никотиновая аддикция, нейротраблшутинг, освобождение от курения, Казань, профессиональная консультация, оздоровление, терапия подсознания, преодоление курения, восстановление здорового образа жизни.',
    content: '',
