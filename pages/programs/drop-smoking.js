...
const schemaOrg = {
  ...
  description: "Бросить курить навсегда — реально! Программа Александра Васильева основана на нейротраблшутинге: глубокая работа с подсознанием, устранение причин зависимости, индивидуальный подход, быстрый результат. Без таблеток и гипноза. Более 1000 успешных случаев, гарантия результата или возврат денег. Ключевые слова: бросить курить, никотиновая зависимость, нейротраблшутинг, избавление от курения, Казань, консультация, здоровье, работа с подсознанием, отказ от курения, восстановление здоровья.",
