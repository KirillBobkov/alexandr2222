...
const schemaOrg = {
  ...
  "description": "Обретите радость и смысл жизни! Программа Александра Васильева — это нейротраблшутинг: устранение апатии, депрессии, уныния, проработка негативных установок, индивидуальный подход, быстрый результат. Более 1000 успешных случаев, гарантия результата или возврат денег. Ключевые слова: апатия, депрессия, полюбить жизнь, нейротраблшутинг, радость жизни, эмоциональные состояния, Казань, консультация, работа с подсознанием, гармония, мотивация.",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Преодоление апатии, уныния, депрессии с помощью нейротраблшутинга',
    ...
    seoContent: 'Обретите жизненную радость и глубокий смысл бытия! Методика Александра Васильева — нейротраблшутинг: ликвидация апатических состояний, депрессивных проявлений, уныния, проработка деструктивных установок, персонализированный подход, стремительные результаты. Свыше 1000 результативных кейсов, обеспечение эффекта или полная компенсация. Ключевые слова: апатические состояния, депрессивные проявления, возрождение любви к жизни, нейротраблшутинг, жизненная радость, эмоциональная регуляция, Казань, экспертная консультация, терапия подсознания, внутренняя гармония, восстановление мотивации.',
    content: '',
