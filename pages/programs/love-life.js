...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Преодоление апатии, уныния и депрессии методом гипнопроработки',
    keywords: 'апатия, депрессия, полюбить жизнь, гипнопроработка, радость жизни, эмоциональные состояния, Казань, консультация, работа с подсознанием',
    seoContent: 'Верните радость и смысл жизни. Гипнопроработка Александра Васильева: устранение апатии, депрессивных проявлений и уныния, проработка разрушительных установок, индивидуальный подход, быстрый эффект. Более 100 успешных кейсов, гарантия результата или возврат средств. Ключевые слова: апатия, депрессия, любовь к жизни, гипнопроработка, радость жизни, эмоциональная регуляция, Казань, консультация, работа с подсознанием, внутренняя гармония, восстановление мотивации.',
    content: '',
