...
"name": "Трансформационная программа «Обретение любви к жизни»",
  "description": "Восстановите радостное восприятие жизни и обретите глубокий смысл существования! Инновационная программа Александра Васильева — передовая направленная медитация: полная нейтрализация апатических состояний, глубокая трансформация депрессивных проявлений, проработка глубинных негативных установок, индивидуально разработанный подход, моментальное достижение устойчивых результатов. Уже свыше 100 успешно завершенных случаев, гарантированный результат или финансовое возмещение. Ключевые слова: трансформация апатии, депрессивные состояния лечение, обретение любви к жизни, направленная медитация эмоционального состояния, восстановление радости жизни, эмоциональное восстановление, Казань, профессиональная консультация, глубинная работа с подсознанием, достижение гармонии, формирование жизненной мотивации, трансформация эмоционального фона.",
  ...
  "serviceType": "Направленная медитация эмоциональных состояний",
  "offers": {
    "@type": "Offer",
    "price": "По запросу",
    "priceCurrency": "RUB",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: 'Преодоление апатии, уныния и депрессии методом направленной медитации',
    keywords: 'апатия, депрессия, полюбить жизнь, направленная медитация, радость жизни, эмоциональные состояния, Казань, консультация, работа с подсознанием',
    seoContent: 'Верните радость и смысл жизни. Направленная медитация Александра Васильева: устранение апатии, депрессивных проявлений и уныния, проработка разрушительных установок, индивидуальный подход, быстрый эффект. Более 100 успешных кейсов, гарантия результата или возврат средств. Ключевые слова: апатия, депрессия, любовь к жизни, направленная медитация, радость жизни, эмоциональная регуляция, Казань, консультация, работа с подсознанием, внутренняя гармония, восстановление мотивации.',
    content: '',
