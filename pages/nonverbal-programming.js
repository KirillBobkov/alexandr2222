...
export default function NonverbalProgramming() {
  ...
  const metaConfig = {
    ...
    description:
      "Быстро сними тревожность, отключи раздражение, убери стыд и включи внутреннюю устойчивость с помощью микродвижений.",
    keywords:
      "невербальное программирование, управление эмоциями, тревожность, раздражение, стыд, внутренняя устойчивость, микродвижения, эмоциональный интеллект, быстрые техники, психология тела, консультация, онлайн-курс",
    seoContent: "Невербальное программирование — авторский курс Александра Васильева по управлению эмоциональными состояниями через телесные микродвижения. Освобождайтесь от тревоги, гнева и стыда, усиливайте внутреннюю стабильность за счёт точных движений тела. Практичный формат, быстрый эффект, доказательная логика, персональная поддержка. Ключевые слова: невербальное программирование, регуляция эмоций, микродвижения, эмоциональная компетентность, телесная психология, экспресс-техники, онлайн-курс, консультация, внутренняя гармония, стресс-менеджмент, эмоциональная устойчивость, личная эффективность.",
  };
  ...
  const schemaOrg = {
    ...
    "@type": "Course",
    name: "Невербальное программирование — управление эмоциями через тело",
    description: "Курс Александра Васильева по невербальному программированию: мгновенное снятие тревожности, раздражения, стыда, включение внутренней устойчивости с помощью микродвижений. Практические техники, быстрый эффект, индивидуальная поддержка. Ключевые слова: невербальное программирование, управление эмоциями, микродвижения, эмоциональный интеллект, психология тела, быстрые техники, онлайн-курс, консультация, гармония, стресс, устойчивость, личная эффективность.",
