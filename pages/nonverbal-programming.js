...
export default function NonverbalProgramming() {
  ...
  const metaConfig = {
    ...
    seoContent: "Невербальное программирование — уникальный курс Александра Васильева по управлению эмоциями через тело. Мгновенно избавьтесь от тревожности, раздражения, стыда, включите внутреннюю устойчивость с помощью микродвижений. Практические техники, быстрый эффект, научный подход, индивидуальная поддержка. Ключевые слова: невербальное программирование, управление эмоциями, микродвижения, эмоциональный интеллект, психология тела, быстрые техники, онлайн-курс, консультация, Александр Васильев, гармония, стресс, устойчивость, личная эффективность.",
  };
