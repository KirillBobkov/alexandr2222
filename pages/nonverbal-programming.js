...
export default function NonverbalProgramming() {
  ...
  const metaConfig = {
    ...
    seoContent: "Невербальное программирование — эксклюзивная программа Александра Васильева по регулированию эмоций посредством телесных практик. Мгновенно освободитесь от беспокойства, гнева, стыдливости, активируйте внутреннюю стабильность через микродвижения тела. Прикладные методики, мгновенный эффект, научно обоснованный подход, персональное сопровождение. Ключевые слова: невербальное программирование, эмоциональная регуляция, микродвижения тела, эмоциональная компетентность, телесная психология, экспресс-техники, дистанционный курс, персональная консультация, Александр Васильев, внутренняя гармония, стресс-менеджмент, эмоциональная устойчивость, персональная продуктивность.",
  };
