...
export default function Blog() {
  ...
  const metaConfig = {
    seoContent: 'Блог Александра Васильева — экспертные статьи о шаманизме, духовных практиках, мухоморных ретритах, работе с подсознанием, вегетализме, психосоматике, личной трансформации. Узнайте, как избавиться от страхов, тревожности, депрессии, найти гармонию и внутреннюю силу. Практические советы, реальные истории, уникальные техники для улучшения жизни. Ключевые слова: шаманизм, духовные практики, мухомор, ретрит, подсознание, психосоматика, гармония, личная трансформация, исцеление, консультация, шаман Казань.',
