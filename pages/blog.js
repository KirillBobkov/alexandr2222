...
export default function Blog() {
  ...
  const metaConfig = {
    seoContent: 'Авторский блог Александра Васильева — экспертные материалы о шаманских традициях, энергетических практиках, церемониях с мухомором, работе с подсознанием, вегетализме, психосоматике и духовном развитии. Узнайте, как преодолевать фобии, тревожность и депрессивные состояния, возвращать внутреннее равновесие и укреплять дух. Практические техники, реальные истории исцеления и рабочие подходы к трансформации. Ключевые слова: шаманские традиции, энергетические практики, мухоморные церемонии, работа с подсознанием, вегетализм, психосоматика, духовное развитие, внутренняя трансформация, исцеление, шаманская консультация Казань.',
    title: "Блог о духовных практиках и природной мудрости",
    description:
      "Статьи о шаманизме, духовных практиках, мухоморных ретритах, работе с подсознанием и личной трансформации.",
