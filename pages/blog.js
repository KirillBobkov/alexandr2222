...
const articles = [
  {
    ...
    description:
      "Столько церемоний удалось провести за последние 8 месяцев. Каждое погружение — шаг в неизвестность. Невозможно предсказать, что откроется, что изменится, и что останется после ретрита.",
    date: "24 августа 2025",
    image: secondary_preview_31,
    slug: "179-panther-amanita-meetings",
  },
  {
    id: 16,
  ...
  },
  {
    ...
    description:
      `Измена — это не просто предательство партнёра. Это глубокий удар по вашей способности доверять — не только другим, но и себе. 
        ...
        Нейротраблшутинг предлагает не «закрыть гештальт», а перепрограммировать саму основу ваших реакций. Рассказываем, как это работает.`,
    date: "18 марта 2025",
...
export default function Blog() {
  ...
  const metaConfig = {
    seoContent: 'Авторский блог Александра Васильева — профессиональные материалы по шаманским традициям, энергетическим практикам, церемониям с мухомором, терапии подсознания, вегетализму, психосоматическим исследованиям, духовному развитию. Откройте секреты преодоления фобий, беспокойства, депрессивных состояний, обретения внутреннего баланса и силы духа. Практические методики, подлинные истории исцеления, эксклюзивные техники трансформации. Ключевые слова: шаманские традиции, энергетические практики, мухоморные церемонии, терапия подсознания, вегетализм, психосоматика, духовное развитие, внутренняя трансформация, исцеление души, шаманская консультация Казань.',
    title: "Блог о духовных практиках и природной мудрости",
    description:
      "Экспертные статьи о шаманизме, духовных практиках, мухоморных ретритах, работе с подсознанием и личной трансформации.",
    keywords: "шаманизм, духовные практики, мухомор, ретрит, подсознание, гармония, психосоматика, личная трансформация, исцеление, шаман Казань",
  };

  const schemaOrg = {
    "@context": "https://schema.org",
    "@type": "Blog",
    "name": "Блог о духовных практиках, шаманизме и личной трансформации",
    "description": "Блог Александра Васильева — экспертные статьи о шаманизме, духовных практиках, мухоморных ретритах, работе с подсознанием, психосоматике, личной трансформации. Практические советы, техники, реальные истории для поиска гармонии, избавления от страхов, тревожности, депрессии и обретения внутренней силы. Ключевые слова: шаманизм, духовные практики, мухомор, ретрит, подсознание, психосоматика, гармония, личная трансформация, исцеление, шаман Казань.",
