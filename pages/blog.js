  ...
  },
  {
    ...
    description:
      `Измена — это не просто предательство партнёра. Это глубокий удар по вашей способности доверять — не только другим, но и себе. 
        ...
        Направленная медитация предлагает не «закрыть гештальт», а перепрограммировать саму основу ваших реакций. Рассказываем, как это работает.`,
    date: "18 марта 2025",
