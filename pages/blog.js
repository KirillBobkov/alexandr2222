...
const articles = [
  ...
  {
    id: 13,
    title: "Гипнопроработка для предпринимателей: преодоление внутренних блоков роста",
    description:
  ...
  {
    id: 7,
    title: "Как перестать быть «вечным спасателем»: гипнопроработка в борьбе с созависимостью",
    description:
  ...
  {
    id: 5,
    title: "Как гипнопроработка помогает пережить измену: восстановление доверия через работу с подсознанием",
    description:
      `Измена — это не просто предательство партнёра. Это глубокий удар по вашей способности доверять — не только другим, но и себе. 
        ...
        Гипнопроработка предлагает не «закрыть гештальт», а перепрограммировать саму основу ваших реакций. Рассказываем, как это работает.`,
    date: "18 марта 2025",
