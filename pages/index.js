...
import { products as hypnoproducts } from "../consts/products";
...
const schemaOrg = {
  ...
  author: {
    ...
    jobTitle:
      "Гипнолог, специалист по работе с подсознанием, проводник мухоморных ретритов",
    knowsAbout: [
    ...
    hasCredential:
      "Опытный проводник мухоморных ретритов, специалист по работе с подсознанием",
    sameAs: [
  ...
  mainEntity: {
    ...
    name: "Александр Васильев",
    description:
      "Гипнолог, устраняющий причины страданий с использованием авторских методик, работы с подсознанием, вегетализма и кинезиологии.",
    sameAs: [
      "https://t.me/chronics44",
      "https://www.tiktok.com/@alexandrvasilev.ru?_t=ZS-8vOVKf5Isrv&_r=1",
      "https://youtube.com/@alexandrvasilev_ru?si=h6JxlRRBXkh8Oxln",
  ...
  offers: [
    ...
    {
      "@type": "Offer",
      name: "Курс направленной медитации",
      price: "125000",
      priceCurrency: "RUB",
      availability: "https://schema.org/InStock",
      url: `${SITE_URL}/neurotroubleshutting`,
      description:
        "Полный курс направленной медитации для устранения психологических блоков и травм.",
    },
  ],
  contactPoint: {
    "@type": "ContactPoint",
  ...
  keywords:
    "гипнолог Казань психолог подсознание психотравмы фобии страхи мухоморный ретрит церемония вегетализм кинезиология депрессия тревожность панические атаки психосоматика исцеление трансформация сознания духовные практики самопознание",
  ...
  return (
    <Layout metaConfig={metaConfig} schemaOrg={schemaOrg}>
      ...
      <InnerSatisfaction
        ...
        description={
          <>
            Если вы чего-то достигли, но эмоциональный дискомфорт (чувство вины,
            ревность, обиды, нервозность, опустошение, суицидальные мысли и
            т.д.) омрачает вашу жизнь, для вас есть хорошие новости.
            <br />
            <br />
            Существует проверенный метод (направленная медитация), который позволяет
            трансформировать эмоции на уровне тела и подсознания в режиме онлайн.
            <br />
            <br />
            Всего за одну сессию получается перенастроить человека на нужный
            лад, без необходимости обсуждать какие-то детали личной жизни.
            <br />
            <br />
            Более того, кто хочет ближе познакомиться с самим собой и кардинально
