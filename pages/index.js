...
export default function () {
  ...
  const metaConfig = {
    ...
    keywords:
      "очищение интеграл ретрит грибы дурман нейротраблшуттинг мухоморный ретрит вегетализм кинезиология",
  };
