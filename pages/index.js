  ...
  return (
    <Layout metaConfig={metaConfig} schemaOrg={schemaOrg}>
      ...
      <InnerSatisfaction
        ...
        description={
          <>
            Если вы чего-то достигли, но потеряли вкус к жизни, разочаровались в
            людях, регулярно испытываете нервозность, апатию или деструктивные
            мысли, не переживайте. Не всё потеряно.
            <br />
            <br />
            Я знаю как вам помочь, и у вас есть бесплатный способ убедиться в
            этом. Что я имею ввиду? Я занимаюсь нейротраблшутингом (решение
            нерешаемых задач через работу с подсознанием) и, в случае отсутствия
            результата, возвращаю деньги.
            <br />
            <br />
