...
const schemaOrg = {
  ...
  offers: [
    {
      "@type": "Offer",
      name: "КОНСУЛЬТАЦИЯ нейротраблшутера",
      price: "0",
      priceCurrency: "RUB",
      availability: "https://schema.org/InStock",
      url: "https://alexandrvasilev.ru/#message",
      description:
        "КОНСУЛЬТАЦИЯ с ведущим нейротраблшутером России. Диагностика проблем, определение путей решения, составление индивидуального плана работы.",
