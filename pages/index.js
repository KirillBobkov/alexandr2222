...
export default function () {
  ...
  const metaConfig = {
    seoContent:
      "Александр Васильев — ведущий нейротраблшутер в Казани. Помогаю избавиться от психологических травм, страхов, фобий, депрессии, тревожности, панических атак, психосоматики. Провожу индивидуальные сессии нейротраблшутинга, авторские мухоморные ретриты, работаю с подсознанием, использую вегетализм и кинезиологию. Бесплатная консультация, диагностика проблем, составление индивидуального плана. Помогаю найти смысл жизни, преодолеть внутренние блоки, улучшить качество жизни. Запишитесь на консультацию к профессионалу — начните путь к гармонии и внутренней свободе уже сегодня!",
