...
const schemaOrg = {
  ...
  description:
    "Александр Васильев — профессиональный нейротраблшутер, эксперт по работе с подсознанием, устранению психотравм, страхов, фобий, депрессии и тревожности. Провожу мухоморные ретриты, индивидуальные программы, гарантирую результат. Более 100 успешных историй преодоления жизненных кризисов. Бесплатная консультация, диагностика, индивидуальный подход. Казань, Россия.",
  ...
  author: {
    ...
    description:
      "Нейротраблшутер. Специализируется на глубинной работе с подсознанием, устранении психотравм и проведении трансформационных мухоморных ретритов. Автор уникальных методик исцеления и самопознания.",
    image: {
      "@type": "ImageObject",
