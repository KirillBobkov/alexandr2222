...
const schemaOrg = `
{
  ...
  "description": "Уникальная практика погружения в глубины подсознания через мухоморный ретрит под руководством опытного проводника Александра Васильева. Путь исцеления и самопознания, открывающий доступ к встрече с Высшими Силами, позволяющий наладить связь с Творцом и раскрыть своё предназначение.",
    ...
    "itemListElement": [
      {
        ...
        "item": {
          ...
          "description": "Освобождение от внутренних зажимов, тяжёлых переживаний и сдерживаемых чувств. Снижение уровня внутреннего напряжения, преодоление последствий психоэмоциональных нагрузок. Глубокое чувство покоя, собранности и целостности после церемонии."
        }
      },
      {
        "@type": "ListItem",
        ...
        "item": {
          ...
          "description": "Уходит тяжесть из тела, появляется лёгкость и свобода движений. Становится проще засыпать, просыпаться и чувствовать себя в ресурсе. Запускаются процессы, которые ощущаются как глубокое восстановление."
        }
      },
      {
        "@type": "ListItem",
        ...
        "item": {
          ...
          "description": "Обретение ясности в мыслях и понимание своих истинных целей. Улучшение качества жизни, отношений, карьеры. Повышение личной эффективности и продуктивности."
        }
      },
      {
        "@type": "ListItem",
        ...
        "item": {
          ...
          "description": "Освобождение от внутренних блоков, стыда, травм. Переосмысление отношения к своему телу и интимности. Пробуждение естественной сексуальной энергии."
        }
      },
      {
        "@type": "ListItem",
        ...
        "item": {
          ...
          "description": "Единение с миром и понимание своего места во Вселенной. Ощущение потока жизни, благодарности и осознанности. Мистические переживания, способные изменить мировоззрение."
        }
      }
    ]
  },
    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          "@type": "Service",
          "name": "Подготовка",
          "description": "Вы получаете рекомендации по диете и грамотную настройку на погружение. Это позволяет сделать церемонию более осмысленной, безопасной и продуктивной."
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          ...
          "description": "Подбирается индивидуальная дозировка. Мухомор употребляется в виде сомы, с добавлением других Растений-Учителей, разрешённых в РФ. Проводятся очистительные и исцеляющие ритуалы, полученные от Высших Сил."
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          ...
          "description": "После ретрита, помощь в осознании смысла полученного опыта, верном применении в жизни и закреплении трансформации."
        }
      }
    ]
  },
  "additionalProperty": [
    {
      ...
      "value": "Назначен проводником непосредственно от самого Мухомора; Глубокая работа с подсознанием; Быстрый, но эффективный формат; Безопасность и грамотная интеграция; Индивидуальная дозировка и перепроверка через кинезиологический тест"
    },
    {
      "@type": "PropertyValue",
      "name": "Исторические примеры использования",
      "value": "Шаманизм и древние традиции; Воинская доблесть и обострение чувств; Духовные ритуалы индейцев; Современные исследования"
    },
    {
      "@type": "PropertyValue",
      "name": "Известные практикующие",
      "value": "Множество выдающихся предпринимателей и лидеров используют шаманские практики для расширения восприятия, глубокого самопознания и раскрытия своего истинного потенциала"
    },
    {
      "@type": "PropertyValue",
      "name": "Риски и предосторожности",
      "value": "Токсичность и побочные эффекты при неправильном употреблении; Риск десоциализации без правильной интеграции; Необходимость опытного проводника"
    }
  ],
  "potentialAction": {
    "@type": "ReserveAction",
  ...
  "review": [
    ...
    },
    {
      ...
      "reviewBody": "Глубокий трансформационный опыт, изменивший моё восприятие жизни"
    },
    {
      "@type": "Review",
      ...
      "reviewBody": "Нашел ответы на глубинные вопросы, которые долго меня беспокоили"
    },
    {
      "@type": "Review",
  ...
  "video": [
    {
      ...
      "description": "Коллекция видеоотзывов от участников мухоморных ретритов в Казани под руководством Александра Васильева",
      "thumbnailUrl": "https://i.mycdn.me/getVideoPreview?id=8011482597949&idx=14&type=39&tkn=2N2-OvszIn7EgxYI2Z-GF-bu2P0&fn=vid_u",
    ...
    <Layout metaConfig={metaConfig} schemaOrg={schemaOrg}>
      ...
      <LineAnimation>
        <div className={containerStyles.container}>
          ...
          <VisibilityManager as="p">
            Эти люди понимают, что истинный успех начинается с
