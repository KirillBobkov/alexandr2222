...
const schemaOrg = {
  ...
  description:
    "Профессиональные мухоморные церемонии в Казани под руководством сертифицированного проводника Александра Васильева. Безопасные трансформационные практики для глубокого самопознания, исцеления психотравм и раскрытия истинного потенциала. Индивидуальный подход, полное сопровождение.",
