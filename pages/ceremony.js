      ...
      <LineAnimation>
        <div className={containerStyles.container}>
          ...
          <VisibilityManager as="div" className={contentStyles.textBlock}>
            ...
            <p className={contentStyles.textDescription}>
              Я, Александр «Интеграл» Васильев, помогаю участникам
              безопасно пройти через опыт.
            </p>
            <p className={contentStyles.textDescription}>
          ...
          <VisibilityManager as="div" className={contentStyles.textBlock}>
            ...
            <p className={contentStyles.textDescription}>
              Процесс сопровождается определёнными ритуалами,
              направленными на очищение и исцеление человека, пробуждение его
              истинного Духа. Эти ритуалы я получил в трипе от Высших Сил, и они
              действительно помогают - смотрите отзывы.
            </p>
          </VisibilityManager>
