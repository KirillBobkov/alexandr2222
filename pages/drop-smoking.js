      ...
      <LineAnimation>
        <div className={containerStyles.container}>
          ...
          <VisibilityManager as="p">
            ...
            поведение, эмоции и даже Ваше самочувствие. Мояметодика направлена
            на работу с Вашим подсознанием, чтобы переписать эти программы. Я
            использую эффективные техники, которые помогают Вам выявить и
            трансформировать подсознательные установки, которые сейчас
            поддерживают Вашу зависимость.
          </VisibilityManager>
          <VisibilityManager as="p">
