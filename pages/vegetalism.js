  ...
  return (
    <Layout metaConfig={metaConfig}>
      ...
      <Final
        ...
        description="Если вы чувствуете, что готовы глубже понять себя, исцелить старые раны и обрести гармонию, я могу стать вашим проводником. Я помогу вам безопасно и осознанно войти в этот мир, чтобы вы могли получить максимум пользы от взаимодействия с силами природы. Свяжитесь со мной, чтобы узнать больше или записаться на консультацию. Ваше путешествие к гармонии начинается здесь."
