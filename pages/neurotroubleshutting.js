      ...
      <InnerSatisfaction
        ...
        description={
          <>
            ...
            <br />
            <b style={{ color: 'var(--accent'}}>●</b> выходим к корневому эпизоду (чаще всего детскому или
            вытесненному);
            <br />
            <br />
            <b style={{ color: 'var(--accent)'}}>●</b> «размораживаем» застрявшие эмоции и блоки;
            <br />
            <br />
            <b style={{ color: 'var(--accent)'}}>●</b> переписываем внутреннюю структуру восприятия;
            <br />
            <br />
            <b style={{ color: 'var(--accent)'}}>●</b> закрепляем результат на уровне ощущений, решений и действий.
            <br />
            <br />
