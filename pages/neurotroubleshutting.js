  ...
  blocks: [
    {
      ...
      answer: `Гипнопроработка – это абсолютно новое направление, которое безопасно и быстро обеспечивает ощутимый результат. 
...
Я помогу вам исправить их ошибки так, чтобы ваша жизнь изменилась к лучшему.`,
    },
    {
      ...
      Это именно то, что я и помогу убрать при помощи гипнопроработки.`,
    },
    {
...
const schemaOrg = {
  ...
  offers: [
    ...
    },
    {
      ...
      availability: "https://schema.org/InStock",
      description:
        "Полный курс гипнопроработки с гарантией результата или возврат 100% денег",
      additionalProperty: {
        "@type": "PropertyValue",
        name: "Гарантия",
  ...
  keywords:
    "гипнопроработка Казань, работа с подсознанием, устранение фобий, лечение депрессии, избавление от тревожности, психосоматика, панические атаки, гипнотерапия, НЛП, психологическая помощь, травмы детства, ограничивающие убеждения",
  ...
  serviceOutput: {
    "@type": "Thing",
    name: "Результаты гипнопроработки",
    description:
...
export default function () {
  ...
  const metaConfig = {
    ...
    keywords:
      "гипнопроработка, гипнотерапия, гипнотерапевт, НЛП, психосоматика, депрессия, тревожность, проработка страхов, экзорцизм, психология, гипноз, подсознательные блоки",
    seoContent:
      "Гипнопроработка — современная методика устранения тревоги, депрессии, фобий, психосоматических реакций, панических эпизодов и подсознательных ограничений. Глубинная работа с подсознанием, персональный подход, быстрые изменения за 4–8 сессий. Бесплатная первичная диагностика, консультация и авторские технологии, безопасная трансформация. Ключевые слова: гипнопроработка Казань, устранение тревожности, депрессивных состояний, фобий, психосоматики, гипнотерапевтические методы, терапия подсознания, избавление от страхов, персональные сессии, быстрый и гарантированный эффект, консультация гипнолога.",
  };
      ...
      <div className={containerStyles.container}>
        <Collapsible title="Описание" defaultOpen={false}>
          ...
          >
            ...
            <p className={contentStyles.textDescription}>
              Гипнопроработка направлена на точечную коррекцию таких паттернов.
            </p>
            <p className={contentStyles.textDescription}>
