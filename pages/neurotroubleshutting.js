  ...
  blocks: [
    {
      ...
      answer: `Направленная медитация – это абсолютно новое направление, которое безопасно и быстро обеспечивает ощутимый результат. 
...
Я помогу вам исправить их ошибки так, чтобы ваша жизнь изменилась к лучшему.`,
    },
    {
      ...
      Это именно то, что я и помогу убрать при помощи направленной медитации.`,
    },
    {
...
const videos = [
  ...
  },
  {
    ...
    name: "Отзывы о направленных медитациях Александра",
...
const schemaOrg = {
  ...
  serviceType: "Направленная медитация",
  offers: [
    {
      "@type": "Offer",
    ...
    },
    {
      ...
      availability: "https://schema.org/InStock",
      description:
        "Полный курс направленной медитации с гарантией результата или возврат 100% денег",
      additionalProperty: {
        "@type": "PropertyValue",
        name: "Гарантия",
  ...
  keywords:
    "направленная медитация Казань, работа с подсознанием, устранение фобий, лечение депрессии, избавление от тревожности, психосоматика, панические атаки, гипнотерапия, НЛП, психологическая помощь, травмы детства, ограничивающие убеждения",
  ...
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    name: "Услуги направленной медитации",
    itemListElement: [
      {
        "@type": "Offer",
        itemOffered: {
  ...
  serviceOutput: {
    "@type": "Thing",
    name: "Результаты направленной медитации",
    description:
...
export default function () {
  ...
  const metaConfig = {
    title: "Направленная медитация | Устранение тревоги, депрессии и психосоматики",
    description:
    ...
    keywords:
      "направленная медитация, гипнотерапия, гипнотерапевт, НЛП, психосоматика, депрессия, тревожность, проработка страхов, экзорцизм, психология, гипноз, подсознательные блоки",
    seoContent:
      "Направленная медитация — современная методика устранения тревоги, депрессии, фобий, психосоматических реакций, панических эпизодов и подсознательных ограничений. Глубинная работа с подсознанием, персональный подход, быстрые изменения за 4–8 сессий. Бесплатная первичная диагностика, консультация и авторские технологии, безопасная трансформация. Ключевые слова: направленная медитация Казань, устранение тревожности, депрессивных состояний, фобий, психосоматики, гипнотерапевтические методы, терапия подсознания, избавление от страхов, персональные сессии, быстрый и гарантированный эффект, консультация гипнолога.",
  };

  return (
    <Layout metaConfig={metaConfig} schemaOrg={schemaOrg} enableParallaxBackground={false}>
      <SecondaryPreview
        text={"Направленная медитация"}
        image={enter_hole_2}
      ...
      <div className={containerStyles.container}>
        <Collapsible title="Описание" defaultOpen={false}>
          <div className={contentStyles.collapsible}>
            ...
            <p className={contentStyles.textDescription}>
              Направленная медитация направлена на точечную коррекцию таких паттернов.
            </p>
            <p className={contentStyles.textDescription}>
      ...
      <div id="message" />
      <Form
        type="Первая консультация (Страница: Направленная медитация)"
      />
    </Layout>
  );
}
