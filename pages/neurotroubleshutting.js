...
const schemaOrg = {
  ...
  description:
    "Революционный метод устранения психологических блоков и травм через работу с подсознанием. Быстрое и эффективное решение проблем: тревожность, депрессия, фобии, психосоматика, панические атаки. Результат за 1-8 сессий с гарантией возврата денег.",
