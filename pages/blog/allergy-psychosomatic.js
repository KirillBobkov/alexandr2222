...
const schemaOrg = `
{
  ...
  "description": "Глубокий анализ психосоматических причин аллергии и как нейротраблшуттинг помогает людям избавиться от нее навсегда",
  ...
  "keywords": "аллергия, психосоматика, нейротраблшуттинг, подсознание, здоровье, психология",
  "about": [
    {
      "@type": "Thing",
    ...
    {
      "@type": "Thing",
      "name": "Нейротраблшуттинг в устранении аллергии",
