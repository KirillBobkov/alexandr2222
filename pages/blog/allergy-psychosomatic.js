...
const schemaOrg = {
  ...
  "description": "Глубокий анализ психосоматических причин аллергии и как нейротраблшутинг помогает людям избавиться от нее навсегда",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description:
      "Глубокий анализ психосоматических причин аллергии и как нейротраблшутинг помогает людям избавиться от нее навсегда",
    keywords:
      "аллергия, психосоматика, нейротраблшутинг, подсознание, здоровье, психология",
    seoContent: "Профессиональный нейротраблшутер предлагает эффективный прогресс у меньшении аллергии через работу с подсознанием. Узнайте, как навсегда избавиться от аллергии без таблеток и уколов.  Cпециалист по нейротраблшутингу поможет устранить психосоматические причины аллергических реакций. Работаем с аллергией любой сложности: пищевая аллергия, поллиноз, аллергия на животных, бытовая аллергия. Безопасные и проверенные методики нейротраблшутинга для лечения аллергии у взрослых и детей. Запишитесь на консультацию к опытному нейротраблшутеру и забудьте об аллергии. Гарантированный результат через работу с подсознанием. Индивидуальный подход и профессиональная помощь в избавлении от аллергических реакций. Современные методы нейротраблшутинга для устранения первопричин аллергии.",
  };
