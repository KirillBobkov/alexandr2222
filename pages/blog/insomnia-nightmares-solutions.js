...
export default function () {
  ...
  const metaConfig = {
    ...
    description: "Как нейротраблшутинг помогает решить проблемы со сном: избавиться от бессонницы и ночных кошмаров через работу с подсознательными конфликтами.",
    ...
    seoContent: "Инсомния и ночные кошмары — не просто расстройства сна, а послания подсознания о внутренних противоречиях и неразрешенных эмоциональных процессах. Нейротраблшутинг способствует обнаружению и ликвидации корневых причин бессонницы, тревожных сновидений, ночных панических эпизодов. Глубинная терапия подсознания, персонализированный подход, быстродействующие результаты. Ключевые слова: нарушения сна, ночные кошмары, нейротраблшутинг, расстройства сна, подсознательные процессы, психология сновидений, ночные фобии, специализированная консультация, Казань, терапия подсознания, оптимизация сна, психотерапевтическая помощь, освобождение от страхов.",
  };
