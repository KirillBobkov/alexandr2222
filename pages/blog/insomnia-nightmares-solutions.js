...
export default function () {
  ...
  const metaConfig = {
    ...
    description:
      "Как нейротраблшутинг помогает решить проблемы со сном: избавиться от бессонницы и ночных кошмаров через работу с подсознательными конфликтами",
    keywords:
      "бессонница, кошмары, сон, нейротраблшутинг, ночные страхи, осознанные сновидения, расстройства сна, психотерапия, психосоматика",
    seoContent: "Бессонница, кошмары и другие проблемы со сном: как нейротраблшутинг помогает решить их через работу с подсознанием",
  };
