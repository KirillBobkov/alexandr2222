...
"headline": "Преодоление созависимости: гипнопроработка как путь к восстановлению личных границ",
  ...
  "about": [
    ...
    {
      "@type": "Thing",
      "name": "Гипнопроработка в психологии",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: "Созависимость — это не забота, а подсознательная ловушка. Как гипнопроработка помогает выйти из роли спасателя и вернуть себе свою жизнь.",
    keywords: "созависимость, гипнопроработка, психология, отношения, спасатель, травмы, консультация, Казань, работа с подсознанием, личные границы, эмоциональная зависимость",
    seoContent: "Созависимость — модель поведения, которую можно изменить. Гипнопроработка помогает выйти из роли вечного спасателя, восстановить личные границы, убрать навязчивое чувство вины и вернуть право на собственную жизнь. Глубокая работа с подсознанием, проработка детских травм, индивидуальный подход, быстрые изменения. Ключевые слова: созависимые отношения, гипнопроработка, психологическая помощь, межличностные связи, синдром спасателя, психологические травмы, консультация, Казань, работа с подсознанием, личные границы, эмоциональная зависимость, восстановление самооценки.",
  };
      ...
      />
        <div className={containerStyles.container}>
          <VisibilityManager as="h1" className={contentStyles.title_middle}>
            Как перестать быть «вечным спасателем»: гипнопроработка в борьбе с созависимостью
          </VisibilityManager>
          ...
          <div style={{ height: "1px" }} />
          <VisibilityManager as="h3" className={contentStyles.title_middle}>
            Как гипнопроработка ломает шаблон «спасателя»?
          </VisibilityManager>
          ...
          <VisibilityManager as="p">
            Гипнопроработка помогает не «стать эгоистом», а вернуть себе право на жизнь. Вашу жизнь.
          </VisibilityManager>
          <p
              style={{
                fontSize: "12px",
