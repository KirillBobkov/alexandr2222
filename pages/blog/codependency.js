...
const schemaOrg = {
  ...
  "@type": "BlogPosting",
"headline": "Преодоление созависимости: нейротраблшутинг как путь к восстановлению личных границ",
  "description": "Созависимые паттерны — это не приговор, а корректируемые психологические установки. Методы нейротраблшутинга эффективно помогают освободиться от деструктивной роли вечного спасателя, восстановить целостность личных границ, нейтрализовать иррациональное чувство вины и вернуть себе законное право на полноценную автономную жизнь. Глубинная нейтрализация подсознательных установок, проработка глубинных детских психологических травм, индивидуально разработанный подход к каждому клиенту, быстрое достижение устойчивых результатов. Ключевые слова: созависимость нейтрализация, нейротраблшутинг отношений, психология личных границ, трансформация спасательского поведения, психологические травмы созависимости, профессиональная консультация, Казань, глубинная работа с подсознанием, восстановление личных границ, эмоциональная независимость, проработка детских травм, комплексное восстановление самооценки, трансформация созависимых паттернов.",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: "Созависимость — это не забота, а подсознательная ловушка. Как нейротраблшутинг помогает выйти из роли спасателя и вернуть себе свою жизнь.",
    ...
    seoContent: "Созависимость — модель поведения, которую можно изменить. Нейротраблшутинг помогает выйти из роли вечного спасателя, восстановить личные границы, убрать навязчивое чувство вины и вернуть право на собственную жизнь. Глубокая работа с подсознанием, проработка детских травм, индивидуальный подход, быстрые изменения. Ключевые слова: созависимые отношения, нейротраблшутинг, психологическая помощь, межличностные связи, синдром спасателя, психологические травмы, консультация, Казань, работа с подсознанием, личные границы, эмоциональная зависимость, восстановление самооценки.",
  };
