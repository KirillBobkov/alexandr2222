...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: "Измена — не приговор для отношений и самооценки. Нейротраблшутинг помогает проработать травму предательства, восстановить доверие к себе и партнёру, избавиться от панических атак, страхов и бессонницы. Глубокая работа с подсознанием, индивидуальный подход, быстрый результат. Ключевые слова: измена, доверие, психология, нейротраблшутинг, травмы, отношения, консультация, Казань, работа с подсознанием, восстановление доверия, проработка травм, личная трансформация, эмоциональное исцеление.",
  };
