...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: "Вегетализм — древняя традиция, объединяющая человека с природной мудростью через сакральное взаимодействие с растительными союзниками. Практики вегетализма, шаманские методы, терапия подсознания, глубинное исцеление тела и души, восстановление внутренней гармонии и духовной силы. Персонализированный подход, консультативная поддержка, защищенные ретриты с растениями-наставниками. Ключевые слова: вегетализм, растительные союзники, энергетические практики, мухоморные церемонии, шаманские традиции, профессиональная консультация, Казань, шаманские методы, внутренняя гармония, терапия подсознания, духовное исцеление, церемониальный ретрит, личностная трансформация, восстановление благополучия.",
  };
