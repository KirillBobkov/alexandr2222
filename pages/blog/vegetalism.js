...
const schemaOrg = `
{
  ...
  "description": "Древняя традиция, объединяющая человека с мудростью природы через взаимодействие с растениями",
  ...
  "author": {
    ...
    "description": "Нейротраблшуттер, специалист по работе с подсознанием и вегетализму",
