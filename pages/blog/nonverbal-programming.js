...
const schemaOrg = {
  ...
  description:
    "Научитесь мгновенно управлять эмоциями через тело. Доказательная методика невербального программирования для эффективного контроля состояний",
...
export default function () {
  ...
  const metaConfig = {
    ...
    keywords:
      "невербальное программирование, управление эмоциями, биофидбек, телесная терапия, психосоматика, состояния",
    seoContent:
      "Профессиональный нейротраблшутер обучает невербальному программированию - методике мгновенного управления эмоциями через тело. Научитесь контролировать свои состояния за 1-2 секунды. Доказательная методика, основанная на биофидбеке и телесно-эмоциональной обратной связи. Курс невербального программирования для управления тревожностью, стрессом, повышения уверенности. 14 проверенных техник для разных эмоциональных состояний. Запишитесь на обучение невербальному программированию к опытному специалисту. Эффективные техники управления эмоциями через тело для повседневной жизни.",
  };
