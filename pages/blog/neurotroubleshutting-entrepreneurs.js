...
export default function () {
  ...
  const metaConfig = {
    ...
    description: "Как нейротраблшутинг помогает предпринимателям устранить подсознательные блоки, мешающие масштабированию бизнеса и личностному росту.",
    ...
    seoContent: "Нейротраблшутинг для бизнесменов — стремительный метод ликвидации внутренних препятствий, самосаботажа, фобий и ограничений, препятствующих развитию предприятия и персональной продуктивности. Глубинная терапия подсознания, персонализированная методология, быстродействующие результаты, сопровождение квалифицированного эксперта. Ключевые слова: нейротраблшутинг для бизнеса, предпринимательство, коммерческий рост, подсознательная работа, внутренние ограничения, бизнес-развитие, масштабирование деятельности, самосаботаж, экспертная консультация, Казань, терапия подсознания, бизнес-психология, персональная эффективность, устранение страхов, предпринимательское развитие.",
  };
