...
const schemaOrg = {
  ...
  "@type": "BlogPosting",
"headline": "Нейротраблшутинг для предпринимателей: трансформация бизнес-блоков в ростовые возможности",
  "description": "Нейротраблшутинг для предпринимателей — инновационный метод быстрой нейтрализации внутренних психологических барьеров, саботажных паттернов, глубинных страхов и ограничивающих убеждений, напрямую мешающих бизнес-развитию и личностной эффективности. Глубокая перестройка подсознательных механизмов, индивидуально разработанный подход, моментальное достижение измеримых результатов, профессиональная поддержка опытного трансформатора. Ключевые слова: нейротраблшутинг бизнес-трансформации, предпринимательский рост, бизнес-психология, нейтрализация внутренних барьеров, бизнес-масштабирование, саботажные паттерны, профессиональная консультация, Казань, глубинная работа с подсознанием, бизнес-эффективность, устранение предпринимательских страхов, трансформация бизнес-развития.",
  ...
  return (
    <Layout metaConfig={metaConfig} schemaOrg={schemaOrg}>
      ...
      <Form
        ...
        title={"КОНСУЛЬТАЦИЯ по нейротраблшутингу"}
