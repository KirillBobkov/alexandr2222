...
export default function () {
  ...
  const metaConfig = {
    ...
    description:
      "Как нейротраблшутинг помогает предпринимателям устранить подсознательные блоки, мешающие масштабированию бизнеса и личностному росту",
    keywords:
      "нейротраблшутинг, предприниматели, бизнес, подсознание, внутренние блоки, рост, масштабирование, саботаж",
  };
