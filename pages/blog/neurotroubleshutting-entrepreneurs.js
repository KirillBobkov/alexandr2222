...
export default function () {
  ...
  const metaConfig = {
    ...
    description: "Как гипнопроработка помогает предпринимателям убрать подсознательные блоки, мешающие масштабированию бизнеса и личному росту.",
    keywords: "гипнопроработка, предприниматели, бизнес, подсознание, внутренние блоки, рост, масштабирование, саботаж, консультация, Казань, работа с подсознанием, бизнес-психология, личная эффективность",
    seoContent: "Гипнопроработка для бизнесменов — быстрый способ убрать внутренние препятствия, самосаботаж, страхи и ограничения, тормозящие рост компании и личной эффективности. Глубокая работа с подсознанием, персональная методика, заметный эффект, поддержка эксперта. Ключевые слова: гипнопроработка для бизнеса, предпринимательство, рост, подсознательная работа, внутренние ограничения, масштабирование, самосаботаж, консультация, Казань, работа с подсознанием, бизнес-психология, личная эффективность, устранение страхов, развитие бизнеса.",
  };

  return (
    <Layout metaConfig={metaConfig} schemaOrg={schemaOrg}>
      <SecondaryPreview 
        text="Гипнопроработка для предпринимателей" 
        image={secondary_preview_26} 
      />
        <div className={containerStyles.container}>
          <VisibilityManager as="h1" className={contentStyles.title_middle}>
            Гипнопроработка для предпринимателей: преодоление внутренних блоков роста
          </VisibilityManager>
          ...
          <VisibilityManager as="h3" className={contentStyles.title_middle}>
            Гипнопроработка — это точечная перезагрузка мышления через подсознание
          </VisibilityManager>
          ...
          <VisibilityManager as="p">
            Гипнопроработка — это быстрый путь туда, где всё начинается: в вашем подсознании.
          </VisibilityManager>
      ...
      <Form
        ...
        type="Гипнопроработка для предпринимателей (статья)"
      />
    </Layout>
  );
} 