...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: "Микродозирование мухомора — современная методика для оптимизации ментального благополучия, творческого потенциала, качества сна и эмоциональной стабильности. Научные и шаманские подходы, защищенная практика, персональные консультации. Раскройте секреты корректного подбора дозировки, изучите разновидности мухомора и методы минимизации рисков. Ключевые слова: микродозирование, мухоморные практики, психоделическая терапия, психическое здоровье, энергетические практики, специализированная консультация, Казань, шаманские традиции, защищенное микродозирование, терапия подсознания, оптимизация сна, креативное развитие, осознанность.",
  };
