...
export default function () {
  ...
  const metaConfig = {
    ...
    keywords:
      "мухомор, ПТСР, травма, исцеление, подсознание, терапия, психика, проводник",
  };
      ...
      <LineAnimation>
        <div className={containerStyles.container}>
          <VisibilityManager as="h1" className={contentStyles.title_middle}>
            Мухомор и терапия ПТСР: исцеление травм через связь с подсознанием
          </VisibilityManager>
          ...
          <VisibilityManager as="div">
            <p className={contentStyles.textDescription}>
              <span className={contentStyles.textSymbol}>●</span>
              {"  "}
              Женщина с ПТСР после домашнего насилия прожила в трипе сцену, где она не была жертвой, а могла постоять за себя. Её тело впервые расслабилось после многих лет напряжения.
            </p>
            <p className={contentStyles.textDescription}>
              <span className={contentStyles.textSymbol}>●</span>
              {"  "}
              Мужчина после фронта, страдавший от кошмаров, увидел себя в трипе, умывающимся светом и отпускающим души погибших товарищей. Сон восстановился уже на третью ночь после ретрита.
            </p>
            <p className={contentStyles.textDescription}>
              <span className={contentStyles.textSymbol}>●</span>
              {"  "}
          ...
          <VisibilityManager as="p">
            Психологи отмечают, что именно мягкий и неагрессивный характер трипа на Мухоморе создаёт условия для глубинной внутренней работы без шокирующих эффектов, свойственных другим веществам.
          </VisibilityManager>
