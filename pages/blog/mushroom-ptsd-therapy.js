...
export default function () {
  ...
  const metaConfig = {
    ...
    description: "Как мухомор помогает в устранении ПТСР и работе с травмами через глубокую связь с подсознанием.",
    ...
    seoContent: "Мухоморные практики и шаманские методы — результативный подход к терапии ПТСР, психологических травм, тревожных расстройств и хронического стресса. Углубленная терапия подсознания, защищенная методология, персонализированный подход, сопровождение квалифицированного проводника. Раскройте способы освобождения от травматических последствий, восстановления здорового сна, возврата жизненной энергии и радости бытия. Ключевые слова: посттравматический стресс, мухоморная терапия, психологические травмы, травматерапия, подсознательная работа, шаманские традиции, профессиональная консультация, Казань, терапия подсознания, защищенная терапия, эмоциональное восстановление, нормализация сна, освобождение от фобий.",
  };
