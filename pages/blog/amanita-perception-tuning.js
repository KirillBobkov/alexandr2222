...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: "Мухомор — древний союзник для расширения сознания и тонкой настройки восприятия. Узнайте, как шаманские практики с мухомором помогают видеть мир по-новому, усиливают креативность, глубину чувств и осознанность. Практические техники, безопасный подход, индивидуальные консультации. Ключевые слова: мухомор, шаманские практики, настройка восприятия, расширение сознания, микродозинг, психология, шаман Казань, консультация, духовные практики, трансформация, осознанность, улучшение жизни.",
  };
