...
const schemaOrg = {
  ...
  "description": "Дисциплина — это не про силу воли, а про внутренние установки и подсознательные блоки. Нейротраблшутинг помогает выявить и устранить причины прокрастинации, вернуть продуктивность и мотивацию, научиться доводить дела до конца. Индивидуальный подход, быстрый результат, глубокая работа с подсознанием. Ключевые слова: дисциплина, прокрастинация, продуктивность, нейротраблшутинг, подсознание, психология, консультация, Казань, работа с подсознанием, мотивация, самоконтроль, личная эффективность.",
...
export default function () {
  ...
  const metaConfig = {
    ...
    description: "Глубокий анализ психологических причин отсутствия дисциплины и как нейротраблшутинг помогает обрести контроль над собой.",
    ...
    seoContent: "Дисциплина — вопрос не волевых усилий, а внутренних убеждений и подсознательных ограничений. Нейротраблшутинг способствует выявлению и ликвидации источников прокрастинации, восстановлению продуктивности и мотивационных ресурсов, освоению навыка завершения начатого. Персональный подход, стремительные результаты, глубинная терапия подсознания. Ключевые слова: самодисциплина, откладывание дел, личная продуктивность, нейротраблшутинг, подсознательные программы, психологическая поддержка, консультация специалиста, Казань, терапия подсознания, внутренняя мотивация, самоконтроль, персональная эффективность.",
  };
