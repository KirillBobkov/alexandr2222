...
export default function () {
  ...
  const metaConfig = {
    ...
    description:
      "Личный опыт проведения 179 церемоний с Пантерным Мухомором за 8 месяцев. Разные типы встреч, трансформации и наблюдения о работе с мухомором.",
    keywords:
    ...
    seoContent: "179 ритуальных сессий с Пантерным Мухомором на протяжении 8 месяцев — авторский опыт и исследования. Каждая церемония неповторима: контакт с Высшими Сущностями, мягкие преобразования, телесное обновление. Мухомор интуитивно реагирует на внутреннее состояние участника, предлагая именно то, что необходимо в данный момент. Защищенная методология, персональные консультации. Ключевые слова: мухоморные сессии, ритуальные церемонии, шаманские традиции, духовная трансформация, энергетические практики, духовные ретриты, шаманский проводник Казань, индивидуальная консультация, мухоморный опыт.",
  };
