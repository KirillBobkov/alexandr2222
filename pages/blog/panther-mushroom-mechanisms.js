...
export default function () {
  ...
  const metaConfig = {
    ...
    description: "Научно-духовный разбор действия активных веществ Пантерного Мухомора и их влияния на подсознание.",
    ...
    seoContent: "Пантерный Мухомор — рабочий инструмент для глубокой терапии подсознания, преобразования психики и тела. Разбираем, как применять его безопасно для личной практики, духовного роста и эмоционального восстановления. Научный и шаманский подходы, персональные консультации, сопровождение опытного проводника. Ключевые слова: пантерный мухомор, психическая трансформация, телесные эффекты, подсознательная работа, шаманский наставник, терапевтические практики, традиции шаманизма, консультация, Казань, безопасная практика, глубинная терапия, эмоциональное восстановление, шаманские методы.",
  };
