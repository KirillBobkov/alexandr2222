...
export default function () {
  ...
  const metaConfig = {
    ...
    description:
      "Научный и духовный взгляд на действие активных веществ и их влияние на подсознание",
    keywords:
      "пантерный мухомор, психика, тело, трансформация, подсознание, проводник, терапия",
  };
