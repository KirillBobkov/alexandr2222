...
export default function () {
  ...
  return (
    <Layout metaConfig={metaConfig}>
      <SecondaryPreview text="Интеграция после мухоморного трипа" image={secondary_preview_19} />
      <LineAnimation>
        <div className={containerStyles.container}>
          <VisibilityManager as="h1" className={contentStyles.title_middle}>
            Для чего нужна интеграция после мухоморного трипа?
          </VisibilityManager>
          ...
          <VisibilityManager as="p" className={contentStyles.textDescription}>
            {"  "}
            Окружение часто не понимает радикальных изменений в поведении. Человек, говорящий на языке символов и «высших истин», теряет контакт с близкими, что ведет к изоляции.
          </VisibilityManager>
          ...
          <VisibilityManager as="div" className={contentStyles.textBlock}>
            ...
            <p className={contentStyles.textDescription}>
              Потеря работы, жилья, накоплений из-за убеждения, что «деньги и быт — это низковибрационные энергии». Человек существует на обочине общества, оправдывая свою ситуацию «духовным путем».
            </p>
          </VisibilityManager>
          ...
          <VisibilityManager as="div" className={contentStyles.textBlock}>
            ...
            <p className={contentStyles.textDescription}>
              Отрицание научных фактов, медицинской помощи, социальных норм под влиянием идей, полученных в трипе. Например, отказ от лечения болезни, так как «тело должно очиститься само».
            </p>
          </VisibilityManager>
          ...
          <VisibilityManager as="div" className={contentStyles.textBlock}>
            ...
            <p className={contentStyles.textDescription}>
              Постоянные поиски «следующего откровения» через повторные трипы, медитации, ритуалы — вместо решения насущных проблем.
            </p>
          </VisibilityManager>
          ...
          <VisibilityManager as="div" className={contentStyles.textBlock}>
            ...
            <p className={contentStyles.textDescription}>
              Человек убежден, что обладает «тайным знанием», недоступным другим, что ведет к конфликтам и отчуждению.
            </p>
          </VisibilityManager>
          ...
          <VisibilityManager as="div" className={contentStyles.textBlock}>
            ...
            <p className={contentStyles.textDescription}>
              Не стоит рушить привычную жизнь радикально. Начните с малого: внедрите одну полезную привычку, пересмотрите отношение к работе, не отказываясь от нее сразу.
            </p>
          </VisibilityManager>
          ...
          <VisibilityManager as="div" className={contentStyles.textBlock}>
            ...
            <p className={contentStyles.textDescription}>
              Используйте практики для улучшения качества жизни, а не бегства от нее. Например, медитация для снижения стресса на работе, а не для отрицания карьеры.
            </p>
          </VisibilityManager>
          ...
          <VisibilityManager as="div" className={contentStyles.textBlock}>
            ...
            <p className={contentStyles.textDescription}>
              Обсуждайте опыт с близкими или в терапевтических группах. Это помогает оставаться «заземленным» и проверять свои идеи на адекватность.
            </p>
          </VisibilityManager>
          ...
          <VisibilityManager as="div" className={contentStyles.textBlock}>
            <h3 className={contentStyles.title_small}>
              <span className={contentStyles.textSymbol}>//</span>
              {"  "}
              Отказ от повторных трипов без интеграции
            </h3>
            <p className={contentStyles.textDescription}>
          ...
          <VisibilityManager as="p">
            Мухоморный трип — инструмент, а не цель. Его ценность — в трансформации, которая делает жизнь осознаннее, гармоничнее и эффективнее. Но без ответственного подхода он может стать ловушкой, где духовные поиски подменяют собой саму жизнь.
          </VisibilityManager>
