...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: "Регрессии — естественный элемент процесса личностной эволюции. Раскройте, как нейротраблшутинг способствует преобразованию регрессий в ступени развития, проработке внутренних препятствий, освобождению от эмоциональных вспышек, истощения и самосаботажа. Практические методики, персонализированный подход, сопровождение квалифицированного эксперта. Ключевые слова: личностные регрессии, индивидуальное развитие, психологическая трансформация, психологическая наука, саморазвитие, нейротраблшутинг, экспертная консультация, Казань, терапия подсознания, эмоциональные регрессии, проработка ограничений, психотерапевтическая помощь, сопровождение изменений.",
  };
