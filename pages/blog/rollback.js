...
"headline": "Трансформационные откаты: преобразование регресса в ступени личностного развития",
  ...
  "keywords": "откаты, личностный рост, трансформация, психология, саморазвитие, гипнопроработка",
  "about": [
    {
      "@type": "Thing",
...
export default function () {
  ...
  const metaConfig = {
    ...
    keywords: "откаты, личностный рост, трансформация, психология, саморазвитие, гипнопроработка, консультация, Казань, работа с подсознанием, эмоциональные откаты, проработка блоков, психотерапия",
    seoContent: "Откаты — естественная часть личностной трансформации. Как гипнопроработка помогает превращать такие регрессии в ступени роста, прорабатывать внутренние препятствия, снижать эмоциональные всплески, истощение и самосаботаж. Практические техники, индивидуальный подход, поддержка специалиста. Ключевые слова: личностные регрессии, развитие, психологическая трансформация, саморазвитие, гипнопроработка, консультация, Казань, работа с подсознанием, эмоциональные откаты, проработка ограничений, психотерапевтическая поддержка, сопровождение изменений.",
  };
