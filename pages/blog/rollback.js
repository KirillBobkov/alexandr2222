...
export default function () {
  ...
  const metaConfig = {
    ...
    description:
      "Глубокий анализ явления откатов в процессе личностного роста, их причин и методов эффективной работы с ними",
    keywords:
      "откаты, личностный рост, трансформация, психология, саморазвитие, исцеление",
  };
