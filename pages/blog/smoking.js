...
export default function () {
  ...
  const metaConfig = {
    ...
    seoContent: "Табакокурение — не просто пагубная привычка, а подсознательный сигнал о необходимости помощи. Нейротраблшутинг способствует обнаружению и ликвидации глубинных истоков никотиновой аддикции: внутренние психотравмы, эмоциональные зажимы, стрессовые состояния. Персонализированный подход, углубленная терапия подсознания, стремительные результаты. Ключевые слова: табакокурение, никотиновая зависимость, психологическая помощь, нейротраблшутинг, психологические травмы, подсознательная работа, профессиональная консультация, Казань, терапия подсознания, освобождение от курения, эмоциональные блокировки, травматерапия, психотерапевтическая помощь, восстановление здоровья.",
  };
