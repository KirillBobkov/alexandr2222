...
const schemaOrg = {
  ...
  "keywords": "ОКР, обсессивно-компульсивное расстройство, навязчивые мысли, компульсии, направленная медитация, подсознание, психология, работа с подсознанием",
  "about": [
    {
      "@type": "Thing",
    ...
    },
    {
      ...
      "description": "Методы направленной медитации для устранения глубинных причин навязчивых состояний"
    }
  ],
  "offers": {
    "@type": "Offer",
...
export default function () {
  ...
  const metaConfig = {
    ...
    keywords:
      "ОКР, обсессивно-компульсивное расстройство, навязчивые мысли, компульсии, направленная медитация, подсознание, психология, консультация, Казань, работа с подсознанием, освобождение от ОКР",
    seoContent: "ОКР (обсессивно-компульсивное расстройство) часто проявляется через специфические «петли»: навязчивая мысль вызывает тревогу, которую временно снижает ритуал. Работа с подсознанием позволяет обратиться к глубинным причинам напрямую, меняя внутреннее восприятие событий из прошлого и ослабляя эмоциональный заряд. В отдельных случаях проблема решается в результате всего одного сеанса. Работа проходит конфиденциально. Ключевые слова: ОКР, навязчивые состояния, направленная медитация, работа с подсознанием, освобождение от тревоги, психотерапия, консультация, Казань.",
  };
    ...
    <Layout metaConfig={metaConfig} schemaOrg={schemaOrg}>
      ...
      />
        <div className={containerStyles.container}>
          ...
          <VisibilityManager as="p">
            Каждый случай индивидуален. Направленная медитация относится к сфере немедицинской помощи и рассматривается энтузиастами как один из способов безопасного управления внутренним состоянием.
          </VisibilityManager>
