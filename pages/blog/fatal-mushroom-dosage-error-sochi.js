...
export default function FatalMushroomDosageErrorSochiPage() {
  ...
  const metaConfig = {
    ...
    seoContent: "Безопасность при работе с мухомором — ключ к глубокому и безопасному опыту. Разбор трагического случая в Сочи: почему важно индивидуально подбирать дозировку, использовать кинеозиологический тест и доверять только опытным проводникам. Практические рекомендации, консультации, шаманские ретриты. Ключевые слова: мухомор, безопасность, ретрит, шаман, передозировка, кинеозиологический тест, дозировка, отравление, фатальная ошибка, консультация шамана, Казань, шаманские практики, индивидуальный подход.",
  };
