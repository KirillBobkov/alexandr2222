...
export default function FatalMushroomDosageErrorSochiPage() {
  ...
  const metaConfig = {
    ...
    description: "Разбор трагического случая в Сочи: смерть IT-специалиста из-за неправильной дозировки Мухомора и важность кинеозиологического теста для безопасности.",
    ...
    seoContent: "Защищенность при взаимодействии с мухомором — основа для глубокого и защищенного переживания. Анализ трагических событий в Сочи: важность персонализированного подбора дозировки, применения кинеозиологической диагностики и работы исключительно с квалифицированными наставниками. Прикладные рекомендации, консультативная поддержка, шаманские погружения. Ключевые слова: мухоморная безопасность, защищенный ретрит, шаманский проводник, избыточная дозировка, кинеозиологическая диагностика, персональная дозировка, токсическое воздействие, критическая ошибка, консультация шаманского мастера, Казань, шаманские традиции, индивидуальная методология.",
  };
