...
export default function FatalMushroomDosageErrorSochiPage() {
  ...
  const metaConfig = {
    ...
    description:
      "Разбор трагического случая в Сочи: смерть IT-специалиста из-за неправильной дозировки Мухомора и важность кинезиологического теста для безопасности.",
    keywords:
      "мухомор, передозировка, Сочи, смерть на ретрите, безопасность, кинезиологический тест, ошибка дозировки, отравление мухомором, фатальный исход",
  };
