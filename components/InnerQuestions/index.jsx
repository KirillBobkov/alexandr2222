  ...
  return (
    ...
    <div className={styles.container}>
      <div className={styles.block}>
        ...
        Это не просто кризис — это зов. Глубокий, настоящий. Он говорит о том, что пришло время вернуться к себе. Не к образу себя, не к роли, а к подлинной сути. Услышать себя, вспомнить, зачем вы здесь — и начать жить осознанно, полно, с ощущением вкуса и правды в каждом дне.
        </VisibilityManager>
      </div>
    </div>
    </LineAnimation>
