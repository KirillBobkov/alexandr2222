      ...
      <div className={styles.container}>
        <div className={styles.logo__container}>
          ...
          <ul className={styles.social__list}>
            <li>
              <span
                ...
                style={{ position: "relative", cursor: "not-allowed", backgroundColor: "transparent" }}
              >
                <svg
                  width="24"
                  height="24"
                ...
                >
                  <path
                    d="M13.0718 18C6.77376 18 3.06576 13.6587 2.92773 6.5H5.87574C5.96775 11.9012 8.23177 14.1495 10.1158 14.6732V6.5H12.8879V11.1932C14.7399 10.9832 16.6879 8.88925 17.3359 6.5H20.108C19.6039 9.44262 17.4879 11.5362 15.9599 12.3637C17.4879 13.0175 19.8639 14.8558 20.8479 18H17.8319C17.0639 15.871 15.2839 14.1622 12.8879 13.9187V18H13.0718Z"
                    fill="currentColor"
                  />
                </svg>
                <div
            ...
            <li>
              <a
                href="https://www.tiktok.com/@alexandrvasilev.ru?_t=ZS-8vOVKf5Isrv&_r=1"
                target="_blank"
                rel="noopener noreferrer"
                className={styles.social__link}
              >
          ...
          <p className={styles.year}>
            © {new Date().getFullYear()} Александр "Интеграл" Васильев
          </p>
        </div>
      </div>
    </footer>
