        ...
        <div className={styles["grid-container"]}>
          ...
          <VisibilityManager className={styles.item5}>
            <TextBlock
              ...
              desc={
                "Вы можете быть уверены, что получите именно то, за чем пришли. Если проблема не решена — Вы всегда можете рассчитывать на 100% возврат средств. Это полная уверенность в том, что результат будет достигнут."
              }
            />
          </VisibilityManager>
        </div>
