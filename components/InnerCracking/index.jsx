        ...
        <div className={styles.block}>
          ...
          <VisibilityManager>
            <p className={styles.paragraph} style={{ maxWidth: 700 }}>
              Потому что изначально вам был дан ресурс. Не просто шанс, а живая сила — как знак доверия от самой Жизни. 
              Когда вы идёте по своему пути, она поддерживает, питает, направляет. Но если свернуть — если начать жить 
              не своей жизнью, пытаться угодить чужим ожиданиям, гнаться за иллюзиями — эта поддержка начинает ускользать.
            </p>
          </VisibilityManager>
